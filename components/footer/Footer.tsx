export const Footer = () => {
  const nav = [
    { href: 'https://www.skillthrive.com', text: 'dribbble' },
    { href: 'https://www.skillthrive.com', text: 'linkedin' },
    { href: 'https://www.skillthrive.com', text: 'twitter' },
    { href: 'https://www.skillthrive.com', text: 'youtube' },
  ];
